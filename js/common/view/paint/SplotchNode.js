...
define( function( require ) {
  ...
  var splotchShapeArea = 12310.8; // Shape.getApproximateArea() - we updated our shape during development, requiring a different scale
  // TODO: don't require two shape areas
  var newSplotchShapeArea = 21426.8; // Shape.getApproximateArea()
  var newSplotchCentroid = new Vector2( 117.37949080493232, 126.91260432847004 ); // Shape.getApproximateCentroid()
  ...
  var transparentColor = new Color( 'transparent' );
  ...
  function SplotchNode( splotch, paintChoiceProperty, options ) {
    ...
    var colorProperty = new DerivedProperty( [ leftColorProperty, rightColorProperty, paintChoiceProperty ].concat( PaintChoice.COLORS ), function( leftColorAmount, rightColorAmount, paintChoice ) {
